...
func (h *Handler) CreateUser(c *gin.Context) {
	...
	if err != nil {
		h.handleError(c, fmt.Errorf("handler.handleBody: %w", err))
		return
	}
	...
	if err != nil {
		h.handleError(c, fmt.Errorf("service.CreateUser: %w", err))
		return
	}
...
func (h *Handler) CreateUserWithRole(c *gin.Context) {
	...
	if err != nil {
		h.handleError(c, fmt.Errorf("service.CreateUserWithRole: %w", err))
		return
	}
...
func (h *Handler) ReadUsers(c *gin.Context) {
	...
	if err != nil {
		h.handleError(c, fmt.Errorf("service.ReadUsers: %w", err))
		return
	}

	h.handleOK(c, http.StatusOK, users)
}
...
func (h *Handler) ReadUser(c *gin.Context) {
	...
	if err != nil {
		h.handleError(c, fmt.Errorf("handler.handleUIDParam: %w", err))
		return
	}
	...
	if err != nil {
		h.handleError(c, fmt.Errorf("service.ReadUser: %w", err))
		return
	}
...
func (h *Handler) DeleteUser(c *gin.Context) {
	...
	if err != nil {
		h.handleError(c, fmt.Errorf("service.DeleteUser: %w", err))
		return
	}

	h.handleOK(c, http.StatusNoContent, nil)
}

// updateUserData is unified handler for all update operations in the system.
func (h *Handler) updateUserData(c *gin.Context, dto any) {
	uid, err := h.handleUIDParam(c)
	if err != nil {
		h.handleError(c, fmt.Errorf("handler.handleUIDParam: %w", err))
		return
	...
	if err != nil {
		h.handleError(c, fmt.Errorf("service.UpdateUserData: %w", err))
		return
	}
